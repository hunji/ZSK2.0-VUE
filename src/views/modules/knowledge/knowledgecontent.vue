...
<script>
import AddOrUpdate from './knowledgecontent-add-or-update'
...
export default {
  ...
  methods: {
    getDataList () {
      ...
      this.$http({
        url: this.$http.adornUrl('/knowledge/content/list'),
        method: 'get',
    ...
    deleteHandle (id) {
      ...
      this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
        ...
        this.$http({
          url: this.$http.adornUrl('/knowledge/content/delete'),
          method: 'post',
    ...
    reviewHandle (id) {
      this.$confirm(`确定['审核通过']操作?`, '提示', {
        ...
        this.$http({
          url: this.$http.adornUrl(`/knowledge/content/review/${id}`),
          method: 'post',
